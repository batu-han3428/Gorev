            ...
            <div className="container-fluid py-1 px-3">
                ...
                <ul className="navbar-nav  justify-content-end">
                    ...
                    <a href="#" className="nav-link text-body p-0">
                        <i className="fa fa-cog fixed-plugin-button-nav cursor-pointer settingsIcon"></i>
                    </a>
                    </li>
